...
import { getAllProdFeatures, getAllProducts, getProductCategories, getProductDates, multerHandler, postProduct, postProductCategorie, postProductDate, productById } from "./service.mjs"
